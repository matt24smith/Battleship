...
public class SetupGUI extends javax.swing.JFrame {
	...
	public SetupGUI() {
		...
		javax.swing.GroupLayout PlacingPanelLayout = new javax.swing.GroupLayout(
				PlacingPanel);
		PlacingPanel.setLayout(PlacingPanelLayout);
		PlacingPanelLayout
				.setHorizontalGroup(PlacingPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								PlacingPanelLayout
										...
										.addGap(138, 138, 138)));
		PlacingPanelLayout
				.setVerticalGroup(PlacingPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								PlacingPanelLayout
	...
	public static boolean doneButton() {
		...
		if (doneButton == true) {
			if (ships[0][0] == null || ships[1][0] == null
					|| ships[2][0] == null) {
