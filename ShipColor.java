         ...
         for(int j=0; j<4; j++){
            if(shipsLocation[i][j]!=null){
               ...
               if(shipsLocation[i][j].equals("A1")){
                  gui.color(gui.jButtonA1);//change colour of button on setupGUI
                  gameGUI.color(gameGUI.jButtonA1);//change color of button on GameGUI
                  A1=true;}//set A1 to true so it can't be recolored
               else if (!(shipsLocation[i][j].equals("A1"))&&A1==false){
                  gui.antiColor(gui.jButtonA1);//reverse colour of button on setupGUI
                  gameGUI.antiColor(gameGUI.jButtonA1);}//reverse color of button on GameGUI
