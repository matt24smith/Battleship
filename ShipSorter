...
public class ShipSorter{
   ...
   /*TODO
   REMOVE LOCATIONS OF IMPOSSIBLE SPOTS - ANYTHING MARKED FALSE
   GET ROTATE FEATURE WORKING*/
   ...
   public static boolean locationCheckAC(){//check if boat exists at location
      ...
      for(int j=0; j<4; j++){
         ...
         if(shipsLocation[0][i].equals(shipsLocation[1][j])||shipsLocation[0][i].equals(shipsLocation[2][j])){//check if element is equal to submarine or destroyer locaiton
            System.out.println("ERROR - SHIP ALREADY AT LOCATION");//error message
            return false;}
         }}}
      return true;
      }
   ...
   public static boolean locationCheckDS(){
      ...
      for(int j=0; j<4; j++){
         ...
         if(shipsLocation[1][i].equals(shipsLocation[0][j])||shipsLocation[1][i].equals(shipsLocation[2][j])){
            System.out.println("ERROR - SHIP ALREADY AT LOCATION");
            return false;}
         }}}
      return true;
      }
   ...
   public static boolean locationCheckSM(){
      ...
      for(int j=0; j<4; j++){
         ...
         if(shipsLocation[2][i].equals(shipsLocation[1][j])||shipsLocation[2][i].equals(shipsLocation[0][j])){
            System.out.println("ERROR - SHIP ALREADY AT LOCATION");
            return false;}
         }}}
      return true;
      ...
      if(rotate == false){//all ships are vertical
         if(name.equals("AircraftCarrier")){//if boat is AircraftCarrier
                if(location.equals("A1")){//if location is A1
                        System.out.println("A1 B1 C1 D1");//print location
                        ...
                        shipsLocation[0][0]="F6";
                        return false;
                }
                else if(location.equals("F7")){
                        System.out.println("F7");
                        shipsLocation[0][0]="F7";
                        return false;
                }
                else if(location.equals("F8")){
                        System.out.println("F8");
                        shipsLocation[0][0]="F8";
                        return false;
                }
                        ...
                        shipsLocation[0][0]="G6";
                        return false;
                }
                else if(location.equals("G7")){
                        System.out.println("G7");
                        shipsLocation[0][0]="G7";
                        return false;
                }
                else if(location.equals("G8")){
                        System.out.println("G8");
                        shipsLocation[0][0]="G8";
                        return false;
                }
                        ...
                        shipsLocation[0][0]="H6";
                        return false;
                }
                else if(location.equals("H7")){
                        System.out.println("H7");
                        shipsLocation[0][0]="H7";
                        return false;
                }
                else if(location.equals("H8")){
                        System.out.println("H8");
                        shipsLocation[0][0]="H8";
                        return false;
                }
        ...
        if(name.equals("Destroyer")){
                if(location.equals("A1")){
                        ...
                        System.out.println("G7");
                        shipsLocation[1][0]="G7";
                        return false;
                }
                else if(location.equals("G8")){
                        System.out.println("G8");
                        shipsLocation[1][0]="G8";
                        return false;
                }
                else if(location.equals("H1")){
                        System.out.println("H1");
                        ...
                        System.out.println("H7");
                        shipsLocation[1][0]="H7";
                        return false;
                }
                else if(location.equals("H8")){
                        System.out.println("H8");
                        shipsLocation[1][0]="H8";
                        return false;
                }
