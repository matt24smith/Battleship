			...
			if (Game.AIScore != 9) {
				if (hitTests >= 1) {
					...
					System.out.println("Location: "
							+ convertArray(attackLocation) + " Attack: "
							+ convertArray(tempLocation));
				}
				...
				if (tempLocation[0] >= 9 || tempLocation[0] <= 0
						|| tempLocation[1] >= 9 || tempLocation[0] <= 0) {
					convertTemp = true;
				...
				if (convertTemp == true) {
					location = convertArray(tempLocation);
				} else {
					location = convertArray(attackLocation);
				}
				// System.out.println(location);
				// ---------------------------------------------------------
				if (location.equals("A1")) {
					if (A1 == true) {// A1 has been shot before
						...
						for (int k = 0; k < 3; k++) {
							for (int m = 0; m < 4; m++) {
								if (playerShips[k][m] != null) {// check if any
																// ships are
																// there
									if (playerShips[k][m].equals("A1")
											&& A1 == false) {
